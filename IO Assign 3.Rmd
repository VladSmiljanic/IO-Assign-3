...
Might actually need to do  log(shares) in that case uncomment out log shares and  replace shares with lnshares in the rest of the code. 
...
ans =
    ...
    (Intercept)       0.07879     0.018098      4.3535    1.9667e-05
    x1             -0.0097574    0.0011657     -8.3702    4.3709e-15
    x2               0.010181    0.0078221      1.3016       0.19429
    x3              -0.001388    0.0080409    -0.17262       0.86309
```
...
B2SLS = inv(X.'*Z*inv(Z.'*Z)*Z.'*X)*X.'*Z*inv(Z.'*Z)*Z.'*shares
...
VB2ls =
   ...
   1.0e-03 *
    ...
    0.3526   -0.0129   -0.0769   -0.0830
   -0.0129    0.0020   -0.0013   -0.0011
   -0.0769   -0.0013    0.0613   -0.0027
   -0.0830   -0.0011   -0.0027    0.0646
...
Compare standard errors and coefficients.
