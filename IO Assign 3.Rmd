...
sum op
    ...
    Variable |       Obs        Mean    Std. Dev.       Min        Max
-------------+--------------------------------------------------------
          op |     11483     2.31896    1.112648   .6536606   19.08734
```

For cross-price elasticities where product k is within the segment, we need to sum the products in the segment and remove product j from that sum. 
